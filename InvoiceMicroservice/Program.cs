...
var busControl = Bus.Factory.CreateUsingRabbitMq(cfg =>
{
    ...
    {
        e.UseInMemoryOutbox();
        e.Consumer<EventConsumer>(c => c.UseMessageRetry(m => m.Interval(5, new TimeSpan(0, 0, 10))));
    }
    );
});
...
{ 
    ...
    { 
        ...
        context.Message.InvoiceItems.ForEach(i => { Console.WriteLine($"With items: Price: {i.Price}, Desc: {i.Description}"); 
